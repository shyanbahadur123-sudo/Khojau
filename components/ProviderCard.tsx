...
export function VerifiedBadge() {
  return (
    <Link
      ...
      className="inline-flex shrink-0 items-center gap-1 rounded-full bg-[#111111]/10 px-2 py-0.5 text-xs font-semibold text-[#111111] hover:bg-[#111111]/20"
    >
  ...
  return (
    <article className="group flex gap-3 rounded-xl border border-black/10 bg-[#FFFFFF] p-4 shadow-sm transition-all duration-200 ease-out hover:shadow-md hover:-translate-y-[2px] hover:border-[#111111]/30">
      {provider.logo_url ? (
        ...
        <span aria-hidden="true" className="grid h-14 w-14 shrink-0 place-items-center rounded-lg bg-[#111111]/10 text-xl font-bold text-[#111111]">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-2 text-sm">
          <a href={`tel:${provider.phone}`} className="inline-flex min-h-[40px] items-center rounded-lg bg-[#111111] px-3 py-2 font-semibold text-white">
            Call
          </a>
