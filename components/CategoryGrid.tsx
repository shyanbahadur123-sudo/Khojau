      ...
      {list.map((c) => (
        <li key={c.slug}>
          <Link
            ...
            className="group flex h-full items-start gap-3 rounded-2xl border border-black/10 bg-[#FFFFFF] p-4 transition-all duration-200 hover:-translate-y-[2px] hover:shadow-md hover:border-[#111111]/30"
          >
