...
import { ClockIcon, GridIcon, HeartIcon, HomeIcon, LogoutIcon, PinIcon, PlusIcon, SearchIcon, UserIcon, ArrowRightIcon, MountainIcon, ChevronLeftIcon, ChevronRightIcon } from "@/components/UiIcon";
    ...
    >
      ...
      {onToggle && (
        <button
          ...
          className="absolute -right-3 top-20 z-30 grid h-8 w-8 place-items-center rounded-full border border-black/10 bg-[#D4AF37] text-[#0B0D10] shadow-lg transition-all duration-200 hover:scale-105 hover:brightness-110 active:scale-95"
        >
