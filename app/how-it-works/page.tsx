...
export default function HowItWorksPage() {
  return (
    <div className="mx-auto max-w-2xl space-y-8 pt-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">How Khojau works</h1>
      ...
      <section aria-labelledby="for-customers">
        <h2 id="for-customers" className="text-2xl font-bold tracking-tight">For customers</h2>
        ...
        <Link href="/search" className="mt-4 inline-block rounded-full bg-[#C9A227] px-5 py-3 font-semibold text-black">Start searching</Link>
      </section>

      <section aria-labelledby="for-businesses">
        <h2 id="for-businesses" className="text-2xl font-bold tracking-tight">For businesses</h2>
        <ol className="mt-3 space-y-3">
        ...
        <Link href="/add-business" className="mt-4 inline-block rounded-full bg-[#C9A227] px-5 py-3 font-semibold text-black">Add your business</Link>
      </section>

      <section aria-labelledby="verification">
        <h2 id="verification" className="text-2xl font-bold tracking-tight">What “verified” means</h2>
      ...
      <section aria-labelledby="reports">
        <h2 id="reports" className="text-2xl font-bold tracking-tight">Reporting a listing</h2>
