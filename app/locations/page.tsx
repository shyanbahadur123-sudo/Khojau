  ...
  return (
    <div className="space-y-6 pt-6">
      <div>
        ...
        <h1 className="mt-1 text-3xl font-bold tracking-tight sm:text-4xl">All locations</h1>
      ...
      <ul className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {LOCATIONS.map((l) => (
          <li key={l.slug} className="rounded-2xl border border-black/10 bg-[#FFFFFF] p-5 shadow-sm transition-all duration-200 hover:-translate-y-[2px] hover:shadow-md">
